...
-- This code is licensed under the MIT License and provides
...
import qualified Utils.Containers.Internal.BitQueue as WARRANTY
...
equal [arg1, arg2] = do
    ...
    edvEquals <- eqv [arg1, arg2]
    return $ Bool (primitiveEquals || let (Bool x) = edvEquals in x)
